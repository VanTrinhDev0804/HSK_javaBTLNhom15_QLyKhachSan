...
public class FrmPhong extends JFrame implements ActionListener, MouseListener, ItemListener {
	...
	// Them phong
	/**
	 * Thêm Phòng vào trong danh sách kiểm tra giá phòng phải >0 Xuất ra danh sách
	 * phòng
	 */
		...
		if (row >= 0) {
			...
			if (cancel == JOptionPane.YES_OPTION && cboTinhTrangP.getSelectedIndex() == 0) {
				...
				try {
					...
					e1.printStackTrace();
					JOptionPane.showMessageDialog(null, "xóa phòng thất bại!", "Thông báo", JOptionPane.ERROR_MESSAGE);
				}
			} else {
